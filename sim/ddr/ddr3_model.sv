    ...
    begin : file_io_open
        ...
        begin
            ...
            $display(
                ...
                "%m: at time %t WARNING: no +model_data option specified, using current directory.",
...
`ifdef MAX_MEM
    ...
    function string sanitize_model_filename(input string raw_name);
        ...
        begin
            ...
            for (idx = 0; idx < sanitized.len(); idx = idx + 1) begin
            ...
            sanitize_model_filename = sanitized;
    ...
    function integer open_bank_file( input integer bank );
        ...
        begin 
            ...
            inst_name = sanitize_model_filename($sformatf("%m"));

            filename = $sformatf("%0s/%0s.%0d", tmp_model_dir, inst_name, bank);
