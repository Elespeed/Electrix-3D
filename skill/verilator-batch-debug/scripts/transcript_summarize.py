#!/usr/bin/env python
"""Shim -> fpga/verilator/scripts/transcript_summarize.py (canonical).

Single source of truth: the skill entry point delegates to the flow script under
fpga/verilator/scripts so the two never drift.
"""
import os
import sys
...
from transcript_summarize import main  # noqa: E402
