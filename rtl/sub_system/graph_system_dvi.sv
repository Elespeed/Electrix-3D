...
// Mini graphics subsystem for the SRAM/DVI architecture.  Unlike the legacy
// graph_system this block owns no MIG/DDRx resources; its sole memory master
// is the 32-bit ExtRAM AXI port below.
module graph_system_dvi #(
    ...
    output logic [4:0]  ext_axi_arid,
    output logic [31:0] ext_axi_araddr,
    output logic [7:0]  ext_axi_arlen,
    output logic [2:0]  ext_axi_arsize,
    output logic [1:0]  ext_axi_arburst,
    output logic        ext_axi_arlock,
    output logic [3:0]  ext_axi_arcache,
    output logic [2:0]  ext_axi_arprot,
    output logic        ext_axi_arvalid,
    input  logic        ext_axi_arready,
    input  logic [4:0]  ext_axi_rid,
    input  logic [31:0] ext_axi_rdata,
    input  logic [1:0]  ext_axi_rresp,
    input  logic        ext_axi_rlast,
    input  logic        ext_axi_rvalid,
    output logic        ext_axi_rready,
    output logic [4:0]  ext_axi_awid,
    output logic [31:0] ext_axi_awaddr,
    output logic [7:0]  ext_axi_awlen,
    output logic [2:0]  ext_axi_awsize,
    output logic [1:0]  ext_axi_awburst,
    output logic        ext_axi_awlock,
    output logic [3:0]  ext_axi_awcache,
    output logic [2:0]  ext_axi_awprot,
    output logic        ext_axi_awvalid,
    input  logic        ext_axi_awready,
    output logic [31:0] ext_axi_wdata,
    output logic [3:0]  ext_axi_wstrb,
    output logic        ext_axi_wlast,
    output logic        ext_axi_wvalid,
    input  logic        ext_axi_wready,
    input  logic [4:0]  ext_axi_bid,
    ...
    gdu_top #(
        ...
        .V_BACK   (V_BACK),
        .V_TOTAL  (V_TOTAL),
        .SCALE_2X ((H_ACTIVE == 640) && (V_ACTIVE == 480))
    ) u_gdu_top (
        ...
        // ExtRAM has no calibration phase.  It is available as soon as reset
        // is released, unlike the former MIG-backed path.
    ...
    // The existing engines issue cache-line (128-bit) transactions.  The
    // physical boundary is deliberately narrowed here, before ExtRAM.
    axi_width_adapter_128_to_32 u_ext_width_adapter (
        .aclk                (aclk),
        .aresetn             (aresetn),
        ...
        .m_axi_arid          (ext_axi_arid),
        .m_axi_araddr        (ext_axi_araddr),
        .m_axi_arlen         (ext_axi_arlen),
        .m_axi_arsize        (ext_axi_arsize),
        .m_axi_arburst       (ext_axi_arburst),
        .m_axi_arlock        (ext_axi_arlock),
        .m_axi_arcache       (ext_axi_arcache),
        .m_axi_arprot        (ext_axi_arprot),
        .m_axi_arvalid       (ext_axi_arvalid),
        .m_axi_arready       (ext_axi_arready),
        .m_axi_rid           (ext_axi_rid),
        .m_axi_rdata         (ext_axi_rdata),
        .m_axi_rresp         (ext_axi_rresp),
        .m_axi_rlast         (ext_axi_rlast),
        .m_axi_rvalid        (ext_axi_rvalid),
        .m_axi_rready        (ext_axi_rready),
        .m_axi_awid          (ext_axi_awid),
        .m_axi_awaddr        (ext_axi_awaddr),
        .m_axi_awlen         (ext_axi_awlen),
        .m_axi_awsize        (ext_axi_awsize),
        .m_axi_awburst       (ext_axi_awburst),
        .m_axi_awlock        (ext_axi_awlock),
        .m_axi_awcache       (ext_axi_awcache),
        .m_axi_awprot        (ext_axi_awprot),
        .m_axi_awvalid       (ext_axi_awvalid),
        .m_axi_awready       (ext_axi_awready),
        .m_axi_wdata         (ext_axi_wdata),
        .m_axi_wstrb         (ext_axi_wstrb),
        .m_axi_wlast         (ext_axi_wlast),
        .m_axi_wvalid        (ext_axi_wvalid),
        .m_axi_wready        (ext_axi_wready),
        .m_axi_bid           (ext_axi_bid),
        .m_axi_bresp         (ext_axi_bresp),
        .m_axi_bvalid        (ext_axi_bvalid),
        .m_axi_bready        (ext_axi_bready)
    );
