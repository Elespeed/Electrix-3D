...
module Axi_CDC (
  ...
  input  wire [127:0]  axiIn_wdata,
  input  wire [15:0]   axiIn_wstrb,
  ...
  output wire [127:0]  axiOut_wdata,
  output wire [15:0]   axiOut_wstrb,
  ...
  wire       [127:0]  wFifo_io_pop_payload_data;
  wire       [15:0]   wFifo_io_pop_payload_strb;
  ...
  wire       [127:0]  rFifo_io_pop_payload_data;
  ...
  StreamFifoCC_1 wFifo (
    ...
    .io_push_payload_data                  (axiIn_wdata[127:0]                            ), //i
    .io_push_payload_strb                  (axiIn_wstrb[15:0]                             ), //i
    .io_push_payload_last                  (axiIn_wlast                                   ), //i
    .io_pop_valid                          (wFifo_io_pop_valid                            ), //o
    .io_pop_ready                          (axiOut_wready                                 ), //i
    .io_pop_payload_data                   (wFifo_io_pop_payload_data[127:0]              ), //o
    .io_pop_payload_strb                   (wFifo_io_pop_payload_strb[15:0]               ), //o
  ...
  StreamFifoCC_4 rFifo (
    ...
    .io_push_payload_data                  (axiOut_rdata[127:0]                          ), //i
    ...
    .io_pop_payload_data                   (rFifo_io_pop_payload_data[127:0]             ), //o
...
module StreamFifoCC_4 (
  ...
  wire       [135:0]  _zz_popCC_readPort_rsp_data;
  ...
  assign popCC_readPort_rsp_id = _zz_popCC_readPort_rsp_data[132 : 128];
  assign popCC_readPort_rsp_resp = _zz_popCC_readPort_rsp_data[134 : 133];
  assign popCC_readPort_rsp_last = _zz_popCC_readPort_rsp_data[135];
...
module StreamFifoCC_1 (
  ...
  output wire          io_push_ready,
  input  wire [127:0]  io_push_payload_data,
  input  wire [15:0]   io_push_payload_strb,
  input  wire          io_push_payload_last,
  output wire          io_pop_valid,
  input  wire          io_pop_ready,
  output wire [127:0]  io_pop_payload_data,
  output wire [15:0]   io_pop_payload_strb,
  output wire          io_pop_payload_last,
  output wire [3:0]    io_pushOccupancy,
  output wire [3:0]    io_popOccupancy,
  input  wire          axiInClk,
  ...
  reg        [144:0]  _zz_ram_port1;
  wire       [3:0]    popToPushGray_buffercc_io_dataOut;
  wire       [3:0]    pushToPopGray_buffercc_io_dataOut;
  wire       [3:0]    _zz_pushCC_pushPtrGray;
  wire       [2:0]    _zz_ram_port;
  wire       [144:0]  _zz_ram_port_1;
  wire       [3:0]    _zz_popCC_popPtrGray;
  reg                 _zz_1;
  wire       [3:0]    popToPushGray;
  wire       [3:0]    pushToPopGray;
  ...
  wire       [2:0]    popCC_readPort_cmd_payload;
  wire       [127:0]  popCC_readPort_rsp_data;
  wire       [15:0]   popCC_readPort_rsp_strb;
  wire                popCC_readPort_rsp_last;
  wire       [144:0]  _zz_popCC_readPort_rsp_data;
  wire                popCC_readArbitation_translated_valid;
  wire                popCC_readArbitation_translated_ready;
  wire       [127:0]  popCC_readArbitation_translated_payload_data;
  wire       [15:0]   popCC_readArbitation_translated_payload_strb;
  wire                popCC_readArbitation_translated_payload_last;
  wire                popCC_readArbitation_fire;
  reg        [3:0]    popCC_ptrToPush;
  reg        [3:0]    popCC_ptrToOccupancy;
  ...
  assign _zz_popCC_readPort_rsp_data = _zz_ram_port1;
  assign popCC_readPort_rsp_data = _zz_popCC_readPort_rsp_data[127 : 0];
  assign popCC_readPort_rsp_strb = _zz_popCC_readPort_rsp_data[143 : 128];
  assign popCC_readPort_rsp_last = _zz_popCC_readPort_rsp_data[144];
  assign popCC_readPort_cmd_valid = popCC_addressGen_fire;
  assign popCC_readPort_cmd_payload = popCC_addressGen_payload;
  assign popCC_readArbitation_translated_valid = popCC_readArbitation_valid;
  assign popCC_readArbitation_ready = popCC_readArbitation_translated_ready;
