...
module scene_ctrl_top #(
 ...
 logic model_valid, load_done, render_done; logic [15:0] model_vertex_count,model_triangle_count; logic [7:0] error_code; logic pipeline_resetn;
